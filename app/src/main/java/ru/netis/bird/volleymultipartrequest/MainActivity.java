package ru.netis.bird.volleymultipartrequest;
...
//				files.put("avatar", new File("/storage/emulated/0/Download/myotee-avatar.png"));
				files.put("userfile", new File("/storage/emulated/0/Download/myotee-avatar.png"));

				Map<String, String> params = new HashMap<>();
//				params.put("token", "DJrlPbpJQs21rv1lP41yiA==");
				params.put("MAX_FILE_SIZE", "30000");

				String uri = "http://bah.yar.ru/test04/upload.php";
